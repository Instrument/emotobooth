...
export const CHROME_SINGLE_LINE_HEIGHT = 75 - (CHROME_VERTICAL_PADDING * 2); // 25
export const CHROME_SPACE_BETWEEN_LINES = (CHROME_SINGLE_LINE_HEIGHT + (CHROME_SINGLE_LINE_HEIGHT / 2)); // 37.50 (was 12.5)
export const CHROME_SHORT_HEIGHT = CHROME_SINGLE_LINE_HEIGHT + (CHROME_VERTICAL_PADDING * 2);
export const CHROME_TALL_HEIGHT = (CHROME_SINGLE_LINE_HEIGHT * 2) + (CHROME_VERTICAL_PADDING * 2) + (CHROME_SPACE_BETWEEN_LINES / 2) - (CHROME_HEX_RADIUS / 2);
